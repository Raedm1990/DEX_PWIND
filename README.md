...
git clone https://github.com/Raedm1990/DEX_PWIND.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf DEX_PWIND && rm -rf .telegram-cli && git clone https://github.com/Raedm1990/DEX_PWIND.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
